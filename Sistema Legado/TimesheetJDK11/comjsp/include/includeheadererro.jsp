...
%>
    <td colspan="2" align="center" style="color:#000000; background-color:#EEEEEE; font-family:Helvetica,Verdana,Arial; font-size:7pt;"><%=UtilBean.formataData(new java.util.Date(),"hh:mm' | 'EEEEE, dd' de 'MMMMM' de 'yyyyy")%> | Login: <%=UtilBean.session_getValue(session,"COM_CDG_USUR")%></td>
   </tr>
  </table>
  </td>
  </tr>
