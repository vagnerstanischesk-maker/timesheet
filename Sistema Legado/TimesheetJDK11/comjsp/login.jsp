...
function maiusculas() {
   document.loginForm.j_username.value = document.loginForm.j_username.value.toUpperCase();
   return true;
...
<% String str_submit = "";
   out.println("<br><br>");
   out.println("<form action=\"j_security_check\" name=\"loginForm\" method=\"POST\" onsubmit=\"maiusculas()\" >");
